        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            .state('app.forms', {
             ...
             .state('app.forms.settings', { 
                    url: '/settings',
                    templateUrl: 'tpl/forms_settings.html',
                    controller: 'FormElemCtrl',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                .then(function() { 
                                    return $ocLazyLoad.load('assets/js/controllers/forms_settings.js');
                                });
                        }]
                    }
                }) 
            ...
            .state('app.tables', {
                ...
                .state('app.tables.dataTables', {
				  ...
				  .state('app.tables.dataTables2', {
                    url: '/dataTables2',
                    templateUrl: 'tpl/tables_dataTables2.html',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                    'dataTables',
